...
class Details_Inventory : Fragment() {
    ...
    override fun onCreateView(
        ...
        val IC_Regresar = root.findViewById<ImageView>(R.id.IC_Regresar_DetailsInventory_Employed)

        val IMG_Item = root.findViewById<ImageView>(R.id.ArchivoIMG_OfferDetails)
        ...
        IC_Regresar.setOnClickListener {
            findNavController().navigate(R.id.navigation_inventory_employed)
        }
