package proyecto.expotecnica.blooming.Admin.sales
...
class Sales : Fragment() {
    ...
    private var miAdaptador: Adaptador_Sales_Admin? = null
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val root = inflater.inflate(R.layout.fragment_sales_admin, container, false)

        val IC_Regresar = root.findViewById<ImageView>(R.id.Regresar_Sales_Admin)
        val IMGUser = root.findViewById<ImageView>(R.id.IMG_User_Sales)
        val RCV_Sales = root.findViewById<RecyclerView>(R.id.RCV_Sales_Admin)
        ...
        CoroutineScope(Dispatchers.IO).launch{
            ...
            withContext(Dispatchers.Main){
                miAdaptador = Adaptador_Sales_Admin(VentasBD)
