...
class ChangePassword : Fragment() {
    ...
    override fun onCreateView(
        ...
        CampoNuevaContra = root.findViewById(R.id.txt_NuevaContra_ChangePassword_Employed)
        CampoConfirmarContra = root.findViewById(R.id.txt_ConfirmarContra_ChangePassword_Employed)
        ImgOjoNuevaContra = root.findViewById(R.id.Img_NuevaContra_ChangePassword_Employed)
        ImgOjoConfirmarContra = root.findViewById(R.id.Img_ConfirmarContra_ChangePassword_Employed)
        Btn_CambiarContra = root.findViewById(R.id.btn_GuardarContra_ChangePassword_Employed)
