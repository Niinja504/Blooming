...
class Profile : Fragment() {
    ...
    override fun onCreateView(
        ...
        val lbl_Nombre = root.findViewById<TextView>(R.id.lbl_Nombre_User_Profile_Admin)
        val lbl_Apellido = root.findViewById<TextView>(R.id.lbl_Apellido_User_Profile_Admin)
        val lbl_Nombre_De_Usuario = root.findViewById<TextView>(R.id.lbl_Nombre_De_Usuario_Profile_Admin)
        val lbl_Edad = root.findViewById<TextView>(R.id.lbl_Edad_Profile_Admin)
        val lbl_Telefono = root.findViewById<TextView>(R.id.lbl_Telefono_Profile_Admin)

        val btn_upload = root.findViewById<ImageView>(R.id.Ic_upload_Profile_Admin)
    ...
    private fun abrirCamara() {
        if (ContextCompat.checkSelfPermission(requireContext(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(requireActivity(), arrayOf(Manifest.permission.CAMERA), REQUEST_CAMERA_PERMISSION_Update_Profile_Admin)
        } else {
            ...
            photoFile?.also {
                ...
                startActivityForResult(intent, REQUEST_IMAGE_CAPTURE_Update_Profile_Admin)
            }
        }
    }
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        when (requestCode) {
            REQUEST_CAMERA_PERMISSION_Update_Profile_Admin -> {
    ...
    private fun abrirGaleria() {
        ...
        if (intent.resolveActivity(requireActivity().packageManager) != null) {
            startActivityForResult(Intent.createChooser(intent, "Select Picture"), REQUEST_IMAGE_PICK_Update_Profile_Admin)
        } else {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            when (requestCode) {
                REQUEST_IMAGE_CAPTURE_Update_Profile_Admin -> {
                ...
                REQUEST_IMAGE_PICK_Update_Profile_Admin -> {
    ...
    companion object {
        private const val REQUEST_IMAGE_CAPTURE_Update_Profile_Admin = 1
        private const val REQUEST_IMAGE_PICK_Update_Profile_Admin = 2
        private const val REQUEST_CAMERA_PERMISSION_Update_Profile_Admin = 100
    }
