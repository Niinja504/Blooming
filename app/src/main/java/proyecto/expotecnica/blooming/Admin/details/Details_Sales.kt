...
class Details_Sales : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_details_sales_admin, container, false)

        val Regresar_Detalles = root.findViewById<ImageView>(R.id.IC_Regresar_Orders_Admin)

        val RCV_Pedido = root.findViewById<RecyclerView>(R.id.RCV_Detalles_Pedido_Admin)
        ...
        val lbl_Hora_Venta = root.findViewById<TextView>(R.id.lbl_HoraVenta_Details_Orders_Admin)
        val lbl_Fecha_Venta = root.findViewById<TextView>(R.id.lbl_FechaVenta_Details_Orders_Admin)
        val lbl_Nombre_Cliente_Venta = root.findViewById<TextView>(R.id.lbl_NombreCliente_Details_Orders_Admin)
        val lbl_Nombre_Empleado_Venta = root.findViewById<TextView>(R.id.lbl_NombreEmpleado_Details_Orders_Admin)
        val lbl_Total_Venta = root.findViewById<TextView>(R.id.lbl_TotalVenta_Details_Orders_Admin)
        ...
        Regresar_Detalles.setOnClickListener {
            findNavController().navigate(R.id.navigation_sales_admin)
        }
