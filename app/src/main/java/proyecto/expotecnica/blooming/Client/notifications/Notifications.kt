package proyecto.expotecnica.blooming.Client.notifications

import DataC.Data_Notifications
import RecyclerViewHelpers.Adaptador_Notifications_Client
...
class Notifications : Fragment() {
    ...
    private var miAdaptador: Adaptador_Notifications_Client? = null
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_notifications_client, container, false)

        val IMGUser = root.findViewById<ImageView>(R.id.IMG_User_Notifications)
        val RCV_Notifications = root.findViewById<RecyclerView>(R.id.RCV_Notifications_Client)
        //Asignarle un Layout al RecyclerView
        RCV_Notifications.layoutManager = LinearLayoutManager(requireContext())
        Buscador = root.findViewById(R.id.txt_Buscar_Notifications_Client)
        val LimpiarBuscador = root.findViewById<ImageView>(R.id.IC_Limpiar_Bucador_Notifications_Client)
            ...
            override fun run() {
                CoroutineScope(Dispatchers.IO).launch {
                    ...
                    withContext(Dispatchers.Main) {
                        miAdaptador = Adaptador_Notifications_Client(NotificationsDB)
