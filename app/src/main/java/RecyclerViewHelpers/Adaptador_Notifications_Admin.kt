...
class Adaptador_Notifications_Admin (var Datos: List<Data_Notifications>): RecyclerView.Adapter<ViewHolder_Notifications_Admin>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder_Notifications_Admin {
        //Conectar el RecyclerView con la Card
        val vista = LayoutInflater.from(parent.context).inflate(R.layout.activity_card_notifications_admin, parent, false)
        return ViewHolder_Notifications_Admin(vista)
    }

    override fun getItemCount() = datosFiltrados.size

    override fun onBindViewHolder(holder: ViewHolder_Notifications_Admin, position: Int) {
