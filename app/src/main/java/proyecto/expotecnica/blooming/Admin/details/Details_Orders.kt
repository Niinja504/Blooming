...
class Details_Orders : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_details_orders_admin, container, false)
        ...
        val lbl_Nombre_Cliente = root.findViewById<TextView>(R.id.lbl_NombreCliente_Details_Orders_Admin)
        val lbl_Fecha_Entrega = root.findViewById<TextView>(R.id.lbl_Fecha_Entrega_Details_orders_Admin)
        val lbl_Direccion_Entrega = root.findViewById<TextView>(R.id.lbl_Direccion_Details_Orders_Admin)
        val lbl_Dedicatoria = root.findViewById<TextView>(R.id.lbl_Dedicatoria_Orders_Admin)
        val lbl_SubTotal = root.findViewById<TextView>(R.id.lbl_SubTotal_Details_Orders_Admin)
