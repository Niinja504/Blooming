...
class ViewHolder_Inventory_Admin (view: View): RecyclerView.ViewHolder(view)  {
    ...
    val CantidadDisponible: TextView = view.findViewById(R.id.lbl_CantidaProducto_Disponible_CardAdmin)
